...
export default function CalorieAI() {
  ...
  // ИИ определяет КБЖУ через DeepSeek
      ...
      const res = await fetch("https://api.deepseek.com/chat/completions", {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `Ты нутрициолог. Пользователь вводит еду на русском языке в свободной форме. Верни ТОЛЬКО JSON массив (без markdown, без пояснений) с 1-4 вариантами. Формат: [{"name":"...","kcal":0,"p":0,"f":0,"c":0}]. name — короткое русское название с весом/порцией. kcal/p/f/c — числа на указанную порцию или 100г. Данные точные и реалистичные.`,
            },
            { role: "user", content: q },
          ],
        }),
